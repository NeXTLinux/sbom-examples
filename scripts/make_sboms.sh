...
do
	...
	if ( ./syft -q -o json registry:${image} > ./results/${ODIR_IMAGE}/sbom/gosbomjson.json ); then
	    ./syft -q convert ./results/${ODIR_IMAGE}/sbom/gosbomjson.json -o spdx-json=./results/${ODIR_IMAGE}/sbom/spdx.json
	    ./syft -q convert ./results/${ODIR_IMAGE}/sbom/gosbomjson.json -o cyclonedx-json=./results/${ODIR_IMAGE}/sbom/cyclonedx.json
	else
